# Assignment 7
This assignment consists of two exercies around transfer learning. Most of the code is already provided.

In order to complete this assignment, all mentioned tasks in both notebooks, 7A and 7B, need to be completed. 

In assignment 7A, the cells of the notebook do not have to be executed - they take quite long. But the code lacks some comments - all lines with three hashtags (###) have to be commented in order to count as complete. 
